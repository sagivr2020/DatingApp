...
@Output() getMemberPhotoChange = new EventEmitter<string>();
 ...
 currentMain: Photo;
  ...
  setMainPhoto(photo: Photo){
    this.userServices.setMainPhoto(this.authService.decodeToken.nameid, photo.id).subscribe(() => {
  ...
  deletePhoto(id: number) {
    this.alertify.confirm('Are you sure you want to delete this photo?', () => {
      this.userServices.deletePhoto(this.authService.decodeToken.nameid, id).subscribe(() => {
